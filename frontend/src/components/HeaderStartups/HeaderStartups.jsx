	...
	useEffect(() => {
		const fetchPopularStartups = () => {
			$api.get('/startups')
				...
				.catch((err) => {
					console.log(
						'Ошибка при получении последних популярных стартапов:',
						err
					);
				});
		};
			...
			<ul className="popular-startups">
				{popularStartups.map((startup, index) => (
					<li key={index} className="popular-startups-item">
						...
						<div className="popular-startups-item-container">
							<h5 className="popular-startups-item-title">
								Описание:
							</h5>
						...
						<div className="popular-startups-item-container">
							<div className="popular-startups-line-item">
								...
								<Link
									...
									className="popular-startups-founder"
								>
									{startup.founder}
								</Link>
							</div>
							<div className="popular-startups-line-item">
								...
								<p className="popular-startups-team">
									{startup.team}
								</p>
							</div>
						</div>
